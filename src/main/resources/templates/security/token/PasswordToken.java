package ${packagePath}.security.token;
...
public class PasswordToken extends UsernamePasswordToken {
    ...
    public PasswordToken(String username, String password, String loginType, String deviceInfo) {
        super(username, password);
        this.loginType = loginType;
    ...
    public PasswordToken(String username, String password, boolean rememberMe, String loginType, String deviceInfo) {
        super(username, password, rememberMe);
        this.loginType = loginType;
        this.deviceInfo = deviceInfo;
    }
